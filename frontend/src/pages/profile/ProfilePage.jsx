...
const ProfilePage = () => {
  ...
  const {
    ...
    // refetching when queryKey changes so
    queryKey: ["userProfile"], // include username to ensure cache is updated
    queryFn: async () => {
  ...
  return (
    <>
      <div className="flex-[4_4_0]  border-r border-gray-700 min-h-screen ">
        {/* HEADER */}
        {isLoading || (isRefetching && <ImSpinner9 />)}
